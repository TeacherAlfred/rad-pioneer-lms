...
import {
  ...
  User, Calendar, MessageSquare, Landmark, Plus,
} from "lucide-react";
                    ...
                    {expenseAllocations.length > 0 && (
                      <div className="p-6">
                        <ExpenseAllocationEditor
                          rows={expenseAllocations}
                          standingExpenses={standingExpenses}
                          onRemove={removeExpenseAllocationRow}
                          onUpdate={updateExpenseAllocationRow}
                          remaining={remainingToPool}
                        />
                      </div>
                    )}
                  </div>
