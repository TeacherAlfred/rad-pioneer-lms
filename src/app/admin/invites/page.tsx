...
export default function InvitesCommandCenter() {
  ...
  const getShareCopy = (type: 'whatsapp' | 'email' | 'linkedin', p: any) => {
    ...
    const formats = {
      whatsapp: `Hi ${firstName}! 🚀\n\nA message from *RAD Academy*. As our revamped website launched this weekend, we are gifting you a personal RAD LMS Access invite.\n\nAs part of the launch, we are offering you a 14-Day Full Access Trial in our Robotics course\n\nClaim your trial license here before it expires:\n${link}\n\nYou are welcome to contact Teacher Alfred if you have any questions on 0737382343.\n\nRegards,\n*RAD Academy Team*`,
