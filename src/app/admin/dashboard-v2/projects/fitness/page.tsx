      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        {!data.connected ? (
          ...
          <>
            ...
            <section>
              <h2 className="text-[11px] font-black uppercase tracking-widest text-stone-400 mb-4">This Week</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <LightStatTile label="Distance" value={`${stats.week_distance_km} km`} icon={RouteIcon} color="text-emerald-600" />
                <LightStatTile label="Runs" value={stats.week_runs} icon={CalendarDays} color="text-blue-600" />
                <LightStatTile
                ...
                <LightStatTile
                  ...
                  color="text-teal-600"
                />
                <LightStatTile label="Active Shoe Alerts" value={stats.active_shoe_alerts} icon={TriangleAlert} color="text-rose-600" />
              </div>
            </section>
            ...
            <section>
              <h2 className="text-[11px] font-black uppercase tracking-widest text-stone-400 mb-4">Recent Activities</h2>
                  ...
                  <tbody>
                    {recent_activities.map((a) => (
                      <tr key={a.id} className="border-b border-stone-50 last:border-0">
                        <td className="px-6 py-3 text-stone-500 whitespace-nowrap">{new Date(a.start_local).toLocaleDateString()}</td>
                        <td className="px-6 py-3 font-bold text-stone-800">{a.name}</td>
