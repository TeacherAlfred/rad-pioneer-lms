...
import { Play, Rocket, UserCheck, Loader2, Wifi, Target, Trophy, Map } from "lucide-react";
    ...
    async function initializeDashboard() {
      ...
      try {
        ...
        if (enrollment) {
          ...
          // DEEP CHECK: Ensure ID comparison is case-insensitive and string-based
          const current = allMissions?.find(m => {
             const archives = m.tech_archive || [];
             const isDone = archives.some((a: any) => 
        ...
        <div className="max-w-4xl mx-auto p-6 md:p-12 space-y-10 relative z-10">
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between px-4">
              ...
              <Link href="/student/courses" className="flex items-center gap-2 text-blue-400 text-[10px] font-black uppercase tracking-widest hover:underline transition-all"><Map size={14} /> View Roadmap</Link>
            </div>
              ...
              <div className="group relative p-[1px] rounded-[56px] bg-gradient-to-r from-[#45a79a] to-blue-500 shadow-2xl">
                <div className="bg-[#020617] rounded-[55px] p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10">
                  <div className="space-y-6 text-left">
                    ...
                    <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter italic uppercase leading-[0.85]">{activeMission.title}</h2>
                  </div>
