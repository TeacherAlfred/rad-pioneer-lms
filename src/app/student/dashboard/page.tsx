...
import { 
  Play, Rocket, UserCheck, Loader2, ArrowUpRight, Cpu,
    ...
    async function initializeDashboard() {
      ...
      try {
        ...
        const { data: enrollmentsData } = await supabase
          .from('enrollments')
          .select('course_id, status, active_task, sandbox_state, courses(*)') // Added sandbox_state
          .eq('student_id', userId);
                  ...
                  >
                          ...
                          {isSandbox ? (
                            ...
                            <div>
                              ...
                              <div className="h-3 w-full bg-slate-800 rounded-full overflow-hidden border border-slate-700/50">
                                <motion.div 
                                  initial={{ width: 0 }}
                                  animate={{ width: '100%' }} // You can make this a real percentage later if you fetch total components
                            ...
                            // STANDARD LINEAR COURSE PROGRESS
                            <>
                              <div>
                                <div className="flex justify-between items-end mb-2">
                                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 flex items-center gap-1.5">
                    ...
                    <div className="md:w-[45%] relative bg-[#020617] flex flex-col overflow-hidden min-h-[260px] md:min-h-0">
                      ...
                      {isSandbox ? (
                        ...
                        // HYPER-SLEEP (No active tasks found in linear course)
